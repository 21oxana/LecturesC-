...
void Method1() // наименование метода, в скобках нет аргумента
{
...
// Вид 3 Метод который что-то прнимает но ничего не возвращает
...
// решение предыдущий задачи с циклом for
...
/* string Replace(string text, char oldValue, char newValue)
{
    ...
    int length = text.Length; //получение длинны строки
